...
U objektno orijentiranoj terminologiji kaže se da je svaki taj automobil instanca (eng. \emph{instance}) iste klase (eng. \emph{class}). Dakle, klasa\index{klasa} je nacrt (eng. \emph{blueprint}) od koje se svaki objekt stvoren. Definicija klase određuje mogućnosti svakog objekta te klase.
...
\begin{lstlisting}[language=Java, caption=BicycleDriver, label=lst:bicycle_driver]
class BicycleDriver {
